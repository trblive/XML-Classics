...
function displayCars(xml) {
    ...
    for (let i = 0; i < cars.length; i++) {
        ...
        carItem.innerHTML = `
            <img src="/XML-Classics/images/${image}" alt="${name} ${model}" class="car-image">
            <div class="car-meta">
                  <h2>${name} (${model})</h2>
    ...
    contentDiv.appendChild(carList);
}
...
function init() {
    ...
    document.getElementById("sale-link").addEventListener("click", fetchCars);

    // add the event listener to the rendered button
    if (document.getElementById("sale-btn")) {
        this.addEventListener("click", fetchCars);
    }
}
